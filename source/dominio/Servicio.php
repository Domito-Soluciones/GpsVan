...
class Servicio {
    ...
    function getPasajeroCentroCosto() {
        return $this->pasajeroCentroCosto;
    }

    function setPasajeroCentroCosto($pasajeroCentroCosto) {
        $this->pasajeroCentroCosto = $pasajeroCentroCosto;
    }
