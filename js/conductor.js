...
function agregarConductor()
{
    ...
    var nacimiento = formatearCadena(formato_fecha($("#nacimiento").val()));
    var tipoLicencia = formatearCadena($("#tipoLicencia").val());
    var vlicencia = formatearCadena($("#vlicencia").val());
    var banco = formatearCadena($("#banco").val());
    var ncuenta = formatearCadena($("#ncuenta").val());
    var tcuenta = formatearCadena($("#tcuenta").val());
    var renta = formatearCadena($("#renta").val());
    var contrato = formatearCadena($("#tipoContrato").val());
    var afp = formatearCadena($("#afp").val());
    var isapre = formatearCadena($("#isapre").val());
    var isapread = formatearCadena($("#isapread").val().split('.').join(''));
    var mutual = formatearCadena($("#mutual").val());
    var seguroInicio = formatearCadena(formato_fecha($("#seguroInicio").val()));
    var descuento = formatearCadena($("#descuento").val());
    var transportista = formatearCadena($("#transportista").val());
...
function modificarConductor()
{
    ...
    var ncuenta = formatearCadena($("#ncuenta").val());
    var tcuenta = formatearCadena($("#tcuenta").val());
    var nacimiento = formatearCadena($("#nacimiento").val());
    var renta = formatearCadena($("#renta").val());
    var contrato = formatearCadena($("#tipoContrato").val());
    var afp = formatearCadena($("#afp").val());
    var isapre = formatearCadena($("#isapre").val());
    var isapread = formatearCadena($("#isapread").val().split('.').join(''));
    var mutual = formatearCadena($("#mutual").val());
    var seguroInicio = formatearCadena($("#seguroInicio").val());
    var descuento = formatearCadena($("#descuento").val());
    var transportista = formatearCadena($("#transportista").val());
    var imagen = $("#imagenOculta").val();
    var archivoContrato = $("#contratoOculta").val();
