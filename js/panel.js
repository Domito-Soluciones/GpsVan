        ...
        if($("#partida").val() !== '')
        {
            if(!buscaPartida) {
                ...
                else
                {
                    ...
                    {
                        $("#contenedor_punto_destino").html("<b>Destino: </b>"+destinos[0]);
                    }
                }
            ...
            else if($("#partida").val() !== partidaActual){
                partidaActual =  $("#partida").val();
                origen = partidaActual;
                $("#contenedor_punto_encuentro").html("<b>Origen: </b>"+origen);
